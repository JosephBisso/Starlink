    ...
    ui(new Ui::Kroatien)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 4068000; //Quelle: https://www.laenderdaten.info/Europa/Kroatien/index.php , Stand: 21.08.2020
...
void Kroatien::on_buttonBox_clicked(QAbstractButton *button)
{
