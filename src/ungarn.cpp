...
void Ungarn::on_buttonBox_clicked(QAbstractButton *button)
{
    ...
    else //Wenn das Datum das aktuelles oder en vergangenes ist:
    {
        ...
        {
           int Einwohnerzahl = 9770000; //Quelle: https://www.laenderdaten.info/Europa/Ungarn/index.php , Stand: 21.08.2020
...
void Ungarn::on_skalaLiear_clicked()
{
...
void Ungarn::on_skalaLogarithm_clicked()
{
