...
Bosnien::Bosnien(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Bosnien)
{
    ui->setupUi(this);
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 3301000; //Quelle:https://www.laenderdaten.info/Europa/Bosnien-und-Herzegowina/index.php , Stand: 21.08.2020
...
void Bosnien::on_buttonBox_clicked(QAbstractButton *button)
{
