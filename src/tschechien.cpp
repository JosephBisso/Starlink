    ...
    ui(new Ui::Tschechien)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 10670000; //Quelle: https://www.laenderdaten.info/Europa/Tschechien/index.php , Stand: 21.08.2020
...
void Tschechien::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Tschechien::on_skalaLiear_clicked()
{
...
void Tschechien::on_skalaLogarithm_clicked()
{
