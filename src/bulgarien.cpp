    ...
    ui(new Ui::Bulgarien)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 6976000; //Quelle:https://www.laenderdaten.info/Europa/Bulgarien/index.php , Stand: 21.08.2020
...
void Bulgarien::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Bulgarien::on_skalaLiear_clicked()
{
...
void Bulgarien::on_skalaLogarithm_clicked()
{
