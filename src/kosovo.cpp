    ...
    ui(new Ui::Kosovo)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 1794000; //Quelle: https://www.laenderdaten.info/Europa/Kosovo/index.php , Stand: 21.08.2020
...
void Kosovo::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Kosovo::on_skalaLiear_clicked()
{
...
void Kosovo::on_skalaLogarithm_clicked()
{
