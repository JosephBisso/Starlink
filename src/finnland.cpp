    ...
    ui(new Ui::Finnland)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 5520000; //Quelle: https://www.laenderdaten.info/Europa/Finnland/index.php , Stand: 21.08.2020
...
void Finnland::on_buttonBox_clicked(QAbstractButton *button)
{
