    ...
    ui(new Ui::Moldawien)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 2658000; //Quelle: https://www.laenderdaten.info/Europa/Moldawien/index.php , Stand: 21.08.2020
...
void Moldawien::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Moldawien::on_skalaLiear_clicked()
{
...
void Moldawien::on_skalaLogarithm_clicked()
{
