    ...
    ui(new Ui::Rumanien)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 19357000; //Quelle: https://www.laenderdaten.info/Europa/Rumaenien/index.php , Stand: 21.08.2020
...
void Rumanien::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Rumanien::on_skalaLiear_clicked()
{
...
void Rumanien::on_skalaLogarithm_clicked()
{
