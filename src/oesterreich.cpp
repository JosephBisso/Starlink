    ...
    ui(new Ui::Oesterreich)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 8877000; //Quelle: https://www.laenderdaten.info/Europa/Oesterreich/index.php , Stand: 21.08.2020
...
void Oesterreich::on_skalaLiear_clicked()
{
...
void Oesterreich::on_skalaLogarithm_clicked()
{
