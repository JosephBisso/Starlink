    ...
    ui(new Ui::Ukraine)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 44385000; //Quelle: https://www.laenderdaten.info/Europa/Ukraine/index.php , Stand: 21.08.2020
...
void Ukraine::on_buttonBox_clicked(QAbstractButton *button)
{
