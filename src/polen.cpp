...
void Polen::on_buttonBox_clicked(QAbstractButton *button)
{
    ...
    else //Wenn das Datum das aktuelles oder en vergangenes ist:
    {
        ...
        {
           int Einwohnerzahl = 37971000; //Quelle: https://www.laenderdaten.info/Europa/Polen/index.php , Stand: 21.08.2020
...
void Polen::on_skalaLiear_clicked()
{
...
void Polen::on_skalaLogarithm_clicked()
{
