    ...
    ui(new Ui::Slowakei)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 5454000; //Quelle: https://www.laenderdaten.info/Europa/Slowakei/index.php , Stand: 21.08.2020
...
void Slowakei::on_buttonBox_clicked(QAbstractButton *button)
{
