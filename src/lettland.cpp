    ...
    ui(new Ui::Lettland)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 1913000; //Quelle: https://www.laenderdaten.info/Europa/Lettland/index.php , Stand: 21.08.2020
...
void Lettland::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Lettland::on_skalaLiear_clicked()
{
...
void Lettland::on_skalaLogarithm_clicked()
{
