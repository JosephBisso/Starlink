    ...
    ui(new Ui::Montenegro)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 622137; //Quelle: https://www.laenderdaten.info/Europa/Montenegro/index.php , Stand: 21.08.2020
...
void Montenegro::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Montenegro::on_skalaLiear_clicked()
{
...
void Montenegro::on_skalaLogarithm_clicked()
{
