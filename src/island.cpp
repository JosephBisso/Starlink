    ...
    ui(new Ui::Island)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 361313; //Quelle: https://www.laenderdaten.info/Europa/Island/index.php , Stand: 21.08.2020
...
void Island::on_buttonBox_clicked(QAbstractButton *button)
{
