    ...
    ui(new Ui::Spanien)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 47077000; //Quelle: https://www.laenderdaten.info/Europa/Spanien/index.php , Stand: 21.08.2020
...
void Spanien::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Spanien::on_skalaLiear_clicked()
{
...
void Spanien::on_skalaLogarithm_clicked()
{
