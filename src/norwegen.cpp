...
void Norwegen::on_buttonBox_clicked(QAbstractButton *button)
{
    ...
    else //Wenn das Datum das aktuelles oder en vergangenes ist:
    {
        ...
        {
           int Einwohnerzahl = 5348000; //Quelle: https://www.laenderdaten.info/Europa/Norwegen/index.php , Stand: 21.08.2020
...
void Norwegen::on_skalaLiear_clicked()
{
...
void Norwegen::on_skalaLogarithm_clicked()
{
