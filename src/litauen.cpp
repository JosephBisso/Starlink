...
void Litauen::on_buttonBox_clicked(QAbstractButton *button)
{
    ...
    else //Wenn das Datum das aktuelles oder en vergangenes ist:
    {
        ...
        {
           int Einwohnerzahl = 2787000; //Quelle: https://www.laenderdaten.info/Europa/Litauen/index.php , Stand: 21.08.2020
...
void Litauen::on_skalaLiear_clicked()
{
...
void Litauen::on_skalaLogarithm_clicked()
{
   Land.skalaLinear = true;
