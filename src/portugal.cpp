    ...
    ui(new Ui::Portugal)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 10269000; //Quelle: https://www.laenderdaten.info/Europa/Portugal/index.php , Stand: 21.08.2020
...
void Portugal::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Portugal::on_skalaLiear_clicked()
{
...
void Portugal::on_skalaLogarithm_clicked()
{
