    ...
    ui(new Ui::Schweiz)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    chartTode->setTitle("Infizierte Tode 2020");
    ...
    double x = 0;
    int Einwohnerzahl = 8575000; //Quelle: https://www.laenderdaten.info/Europa/Schweiz/index.php , Stand: 21.08.2020
...
void Schweiz::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Schweiz::on_skalaLiear_clicked()
{
...
void Schweiz::on_skalaLogarithm_clicked()
{
