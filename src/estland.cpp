    ...
    ui(new Ui::Estland)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 1327000; //Quelle: https://www.laenderdaten.info/Europa/Estland/index.php , Stand: 21.08.2020
...
void Estland::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Estland::on_skalaLiear_clicked()
{
...
void Estland::on_skalaLogarithm_clicked()
{
