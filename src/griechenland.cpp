    ...
    ui(new Ui::Griechenland)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 10716000; //Quelle: https://www.laenderdaten.info/Europa/Griechenland/index.php , Stand: 21.08.2020
...
void Griechenland::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Griechenland::on_skalaLiear_clicked()
{
...
void Griechenland::on_skalaLogarithm_clicked()
{
