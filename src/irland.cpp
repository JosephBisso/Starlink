    ...
    ui(new Ui::Irland)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    chart->setTitle("Überischt Infizierte 2020");
    ...
    double x = 0;
    int Einwohnerzahl = 4941000; //Quelle: https://www.laenderdaten.info/Europa/Irland/index.php , Stand: 21.08.2020
...
void Irland::on_buttonBox_clicked(QAbstractButton *button)
{
