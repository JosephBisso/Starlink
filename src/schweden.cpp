    ...
    ui(new Ui::Schweden)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 10285000; //Quelle: https://www.laenderdaten.info/Europa/Schweden/index.php , Stand: 21.08.2020
...
void Schweden::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Schweden::on_skalaLiear_clicked()
{
...
void Schweden::on_skalaLogarithm_clicked()
{
