    ...
    ui(new Ui::Serbien)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 6945000; //Quelle: https://www.laenderdaten.info/Europa/Serbien/index.php , Stand: 21.08.2020
...
void Serbien::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Serbien::on_skalaLiear_clicked()
{
...
void Serbien::on_skalaLogarithm_clicked()
{
