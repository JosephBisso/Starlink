    ...
    ui(new Ui::Slowenien)
{
    ...
    *set1 << TodeMonat[0] << TodeMonat[1] << TodeMonat[2] << TodeMonat[3]
    ...
    double x = 0;
    int Einwohnerzahl = 2088000; //Quelle: https://www.laenderdaten.info/Europa/Slowenien/index.php , Stand: 21.08.2020
...
void Slowenien::on_buttonBox_clicked(QAbstractButton *button)
{
...
void Slowenien::on_skalaLiear_clicked()
{
...
void Slowenien::on_skalaLogarithm_clicked()
{
