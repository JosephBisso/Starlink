...
void Niederlande::on_buttonBox_clicked(QAbstractButton *button)
{
    ...
    else //Wenn das Datum das aktuelles oder en vergangenes ist:
    {
        ...
        {
           int Einwohnerzahl = 17333000; //Quelle: https://www.laenderdaten.info/Europa/Niederlande/index.php , Stand: 21.08.2020
...
void Niederlande::on_skalaLiear_clicked()
{
...
void Niederlande::on_skalaLogarithm_clicked()
{
