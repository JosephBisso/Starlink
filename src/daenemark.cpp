...
void Daenemark::on_buttonBox_clicked(QAbstractButton *button)
{
    ...
    else //Wenn das Datum das aktuelles oder en vergangenes ist:
    {
        ...
        {
           int Einwohnerzahl = 5819000; //Quelle:https://www.laenderdaten.info/Europa/Daenemark/index.php , Stand: 21.08.2020
...
void Daenemark::on_skalaLiear_clicked()
{
...
void Daenemark::on_skalaLogarithm_clicked()
{
